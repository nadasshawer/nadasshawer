...
<h1 align="center" style="font-family: 'Brush Script MT', cursive; font-weight:bold; background: linear-gradient(to right, #4DA3FF, #1F8FFF, #9AD0FF); -webkit-background-clip: text; color: transparent; margin-bottom:0; font-size:100px">
  Hi, I'm Nada
</h1>
